...
Output day_2017_21(const std::vector<std::string> & lines, const DayExtraInfo &);
...
static constexpr std::array<DayEntryPoint *, 25> days_2017 {
    ...
    &day_2017_21, &day_2017_22, &day_2017_23, &day_2017_24, &day_2017_25
};

int main(int argc, const char * argv[]) {
    run_aoc(days_2017, argc, argv);
    return 0;
}
